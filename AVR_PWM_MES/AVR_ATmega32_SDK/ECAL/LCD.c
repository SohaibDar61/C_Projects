...
static void LCD_WriteCommand(u8 Command)
{
	DIO_WritePin(RS,LOW);
	DIO_WritePin(RW,LOW);
	DIO_WritePin(D5,CHECK_BIT(Command,4));
	DIO_WritePin(D6,CHECK_BIT(Command,5));
	DIO_WritePin(D7,CHECK_BIT(Command,6));
	DIO_WritePin(D8,CHECK_BIT(Command,7));
	DIO_WritePin(EN,HIGH);
	_delay_ms(2);
	DIO_WritePin(EN,LOW);
	_delay_ms(2);
	DIO_WritePin(D5,CHECK_BIT(Command,0));
	DIO_WritePin(D6,CHECK_BIT(Command,1));
	DIO_WritePin(D7,CHECK_BIT(Command,2));
	DIO_WritePin(D8,CHECK_BIT(Command,3));
	DIO_WritePin(EN,HIGH);
	_delay_ms(2);
	DIO_WritePin(EN,LOW);
	_delay_ms(2);
...
static void LCD_WriteData(u8 Data)
{
	DIO_WritePin(RS,HIGH);
	DIO_WritePin(RW,LOW);
	DIO_WritePin(D5,CHECK_BIT(Data,4));
	DIO_WritePin(D6,CHECK_BIT(Data,5));
	DIO_WritePin(D7,CHECK_BIT(Data,6));
	DIO_WritePin(D8,CHECK_BIT(Data,7));
	DIO_WritePin(EN,HIGH);
	_delay_ms(2);
	DIO_WritePin(EN,LOW);
	_delay_ms(2);
	DIO_WritePin(D5,CHECK_BIT(Data,0));
	DIO_WritePin(D6,CHECK_BIT(Data,1));
	DIO_WritePin(D7,CHECK_BIT(Data,2));
	DIO_WritePin(D8,CHECK_BIT(Data,3));
	DIO_WritePin(EN,HIGH);
	_delay_ms(2);
	DIO_WritePin(EN,LOW);
	_delay_ms(2);
...
void LCD_WriteNumber2(u8 Number)
{
